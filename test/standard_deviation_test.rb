...
class StandardDeviationTest < Minitest::Test
  ...
  def test_sum_of_squared_numbers
    ...
    assert_equal 343.2, deviation.squared_sum
  end

  def test_average_of_squared_numbers
    ages = [24, 30, 18, 20, 41]
    deviation = StandardDeviation.new(ages)

    assert_equal 68.64, deviation.squared_numbers_average
  end
  ...
  def test_answer
    ...
    assert_equal 8.28, deviation.answer
  end
end
